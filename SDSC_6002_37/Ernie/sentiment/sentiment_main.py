...
train_ds = load_dataset(read, data_path='/home/Courses/sdsc6001/sdsc6001_008/6002/Data/sentiment/emotion_train_data.csv',lazy=False)
dev_ds = load_dataset(read, data_path='/home/Courses/sdsc6001/sdsc6001_008/6002/Data/sentiment/emotion_dev_data.csv',lazy=False)
...
epochs = 10 # 训练轮次
ckpt_dir = "ernie_ckpt_base" #训练过程中保存模型参数的文件夹
best_acc = 0
best_step = 0
global_step = 0 #迭代次数
tic_train = time.time()
